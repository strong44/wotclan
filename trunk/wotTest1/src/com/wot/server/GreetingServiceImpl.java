...
public class GreetingServiceImpl extends RemoteServiceServlet implements GreetingService {
	...
	public String greetServer(String input) throws IllegalArgumentException {
		...
		try {
			 ...
			 */
			// recup des id du clan NVS
			URL urlClan = new URL("http://redblouse.info/index.php?q=http%3A%2F%2Fapi.worldoftanks.eu%2Fcommunity%2Fclans%2F500006074%2Fapi%2F1.0%2F%3Fsource_token%3DWG-WoT_Assistant-1.3.2&hl=0000000001");
			//urlClan = new URL("http://redblouse.info/index.php?q=http%3A%2F%2Fapi.worldoftanks.eu%2Fcommunity%2Fclans%2F500006074%2Fapi%2F1.0%2F%3Fsource_token%3DWG-WoT_Assistant-1.3.2&hl=0000000001");
			...
			if (clan != null) {
				...
				for (DataCommunityClanMembers dataMember : listMembers) {
					...
					URL url = new URL("http://redblouse.info/index.php?q=http://api.worldoftanks.eu/community/accounts/" + idUser + "/api/1.0/?source_token=WG-WoT_Assistant-1.3.2");
