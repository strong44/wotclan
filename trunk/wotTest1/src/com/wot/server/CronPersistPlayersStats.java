...
//			readerUser.close();
//			Gson gsonUser = new Gson();
//			PlayersInfos playerRatings = gsonUser.fromJson(AllLinesUser, PlayersInfos.class);
//			//Transform playerRatings en communityAccount (pour utiliser des types compatibles avec la s�rialisation (pas de MAP !!))
...
//				        	//must transform before persist the objet clan
//				        	pm.currentTransaction().begin();
//				        	DaoCommunityAccount2 daoCommunityAccount2 = TransformDtoObject.TransformCommunityAccountToDaoCommunityAccount(communityAccount);
//				        	
//				        	//pour eviter trop de donn�es en base 60 write OP 
//				        	//daoCommunityAccount.getData().setAchievements(null);
//				        	daoCommunityAccount2.setDateCommunityAccount(date);
