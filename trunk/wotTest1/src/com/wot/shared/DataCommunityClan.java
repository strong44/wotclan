...
"it":"?????? ????????","hu":"?????? ????????","zh-cn":"?????? ????????","pl":"?????? ????????","ms":"?????? ????????","cs":"?????? ????????","es":"?????? 
	...
	Map<String, DataCommunityClanMembers> members; //m�dailles du joueur

	public Map<String, DataCommunityClanMembers> getMembers() {
		return members;
	}

	public void setMembers(Map<String, DataCommunityClanMembers> members) {
