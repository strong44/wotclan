...
public class TanksToJson implements Serializable {
	 ...
	 */
	private static final long serialVersionUID = 7575765265996883855L;

	//List<TankToJson> tankToJson = new ArrayList<TankToJson>();
